...
def test_time_entry__returns_the_difference_between_date_in_and_date_out__when_calling_get_time_entry_function():
    code = uuid.uuid4()
...
def test_time_entry__set_and_get_time_entry_date_in_attribute__when_calling_date_in_setter_and_getter():
    code = uuid.uuid4()
    time_entry: TimeEntry = TimeEntry(
        code,
        project="ioet Inc. - ioet-internal",
